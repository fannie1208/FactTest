...
if __name__ == "__main__":
    ...
    model_name = 'claude'
    if args.stored:
        with open(f"../training_data/pararel_{args.dataset}_{args.num_try}_{model_name}_kernel_certainties.json",'r') as f:
        ...
        with open(f"../training_data/pararel_{args.dataset}_{args.num_try}_{model_name}_kernel_certainties.json",'w') as f:
