...
if __name__ == "__main__":
    ...
    if args.stored:
        with open(f"../training_data/WiCE_{args.dataset}_{args.num_try}_{model_name}_certainties.json",'r') as f:
        ...
        with open(f"../training_data/WiCE_{args.dataset}_{args.num_try}_{model_name}_certainties.json",'w') as f:
